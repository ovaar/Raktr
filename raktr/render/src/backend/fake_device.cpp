...
namespace raktr::render::backend
{
                            ...
                            uint32_t index_count)
    {
        ...
        switch (_vertex_format) {
            case VertexFormat::Position:       vertex_stride = 3; break;
            case VertexFormat::PositionNormal: vertex_stride = 6; break;
            case VertexFormat::PositionUV:     vertex_stride = 5; break;
            case VertexFormat::PositionNormalUV: vertex_stride = 8; break;
        }
    ...
    float FakeDevice::calculate_lighting(const float* normal) const
    {
        ...
        const float dot = std::max(0.0f, nx * light_dir[0] + 
                                        ny * light_dir[1] + 
                                        nz * light_dir[2]);
