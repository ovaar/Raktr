/*!
 * @file wgpu_render_pass_builder.cpp
 * @brief Implementation of WgpuRenderPassBuilder fluent API.
 */

#include "wgpu_render_pass_builder.h"

namespace raktr::render::backend::wgpu
{

    WgpuRenderPassBuilder& WgpuRenderPassBuilder::color_attachment(
    ...
    WgpuRenderPassBuilder& WgpuRenderPassBuilder::depth_attachment(
        WGPUTextureView target,
        WGPULoadOp      load_op,
        float           clear_depth)
    {
    ...
    WgpuRenderPassBuilder& WgpuRenderPassBuilder::label(std::string_view name)
    {
        _label = name;
        return *this;
    }

    WGPURenderPassEncoder WgpuRenderPassBuilder::begin(WGPUCommandEncoder encoder)
    {
