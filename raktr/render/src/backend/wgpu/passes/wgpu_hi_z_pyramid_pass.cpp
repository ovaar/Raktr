...
namespace raktr::render::backend::wgpu
{
    ...
    WgpuHiZPyramidPass::WgpuHiZPyramidPass(
        ...
        : _hi_z_buffer(hi_z_buffer), _depth_texture(depth_texture)
    {
        ...
        {
            spdlog::warn("WgpuHiZPyramidPass: Hi-Z buffer is null, pyramid generation will be skipped");
        }
    }

    void WgpuHiZPyramidPass::execute([[maybe_unused]] WgpuPassContext& ctx)
    {
        ...
        {
            spdlog::error("WgpuHiZPyramidPass: Failed to build depth pyramid: {}",
                          result.error().message());
        }
    }

    void WgpuHiZPyramidPass::on_viewport_resize([[maybe_unused]] uint32_t width, [[maybe_unused]] uint32_t height)
    {
    ...
    void WgpuHiZPyramidPass::update_depth_texture(WGPUTexture depth_texture)
    {
